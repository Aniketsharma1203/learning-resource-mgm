...
const TeachersList = () => {
    const [teacherUids, setUids] = useState([]);
    const [teacherInfo, setInfo] = useState([]);
    const [expandedTeacher, setExpandedTeacher] = useState(null); // State to manage expanded teacher details
    ...
    const getAllUids = async () => {
        try {
            const uidRef = collection(db, "teacher");
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-600">
            <div className="w-[90vw] h-[80vh] flex bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="w-[80%] bg-gray-100 p-8 overflow-y-auto">
                    {state === "Dashboard" && (
                        <div>
                            <h1 className="text-3xl font-semibold mb-8">Teachers List</h1>
